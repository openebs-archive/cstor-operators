...
|------------|------|---------|
| https://openebs.github.io/node-disk-manager | openebs-ndm | 1.4.1 |
...
| admissionServer.image.tag | string | `"2.9.0"` | Admission webhook image tag |
...
| cspcOperator.image.tag | string | `"2.9.0"` |  CSPC operator image tag |
...
| cspcOperator.poolManager.image.tag | string | `"2.9.0"` | CStor Pool Manager image tag |
...
| cstorCSIPlugin.image.tag | string | `"2.9.0"` | CStor CSI driver image tag |
...
| cvcOperator.image.tag | string | `"2.9.0"` | CVC operator image tag |
...
| cvcOperator.target.image.tag | string | `"2.9.0"` | Volume Target image tag |
...
| cvcOperator.volumeExporter.image.tag | string | `"2.9.0"` | Volume exporter image tag |
...
| cvcOperator.volumeMgmt.image.tag | string | `"2.9.0"` |  Volume mgmt image tag|
...
| release.version | string | `"2.9.0"` | Openebs CStor release version |
