...
| admissionServer.image.tag | string | `"2.12.0"` | Admission webhook image tag |
...
| cspcOperator.cstorPool.image.tag | string | `"2.12.0"` | CStor pool image tag |
...
| cspcOperator.cstorPoolExporter.image.tag | string | `"2.12.0"` | CStor pool exporter image tag |
...
| cspcOperator.image.tag | string | `"2.12.0"` |  CSPC operator image tag |
...
| cspcOperator.poolManager.image.tag | string | `"2.12.0"` | CStor Pool Manager image tag |
...
| cstorCSIPlugin.image.tag | string | `"2.12.0"` | CStor CSI driver image tag |
...
| cvcOperator.image.tag | string | `"2.12.0"` | CVC operator image tag |
...
| cvcOperator.target.image.tag | string | `"2.12.0"` | Volume Target image tag |
...
| cvcOperator.volumeExporter.image.tag | string | `"2.12.0"` | Volume exporter image tag |
...
| cvcOperator.volumeMgmt.image.tag | string | `"2.12.0"` |  Volume mgmt image tag|
...
| release.version | string | `"2.12.0"` | Openebs CStor release version |
