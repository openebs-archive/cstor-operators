...
func (c *CStorPoolInstanceController) Run(threadiness int, stopCh <-chan struct{}) error {
	...
	klog.Info("Starting CStorPoolInstance controller")
	...
	klog.Info("Starting CStorPoolInstance workers")
...
func (c *CStorPoolInstanceController) processNextWorkItem() bool {
	...
	err := func(obj interface{}) error {
		...
		c.workqueue.Forget(obj)
		klog.V(4).Infof("Successfully synced '%s' for operation: %s", q.Key, string(q.Operation))
		return nil
	}(obj)
