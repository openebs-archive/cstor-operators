...
func TestProcessNextWorkItemAdd(t *testing.T) {
	...
	_, err := volumeReplicaController.clientset.CstorV1().CStorVolumeReplicas("default").Create(context.TODO(), testPoolResource["img2PoolResource"].test, metav1.CreateOptions{})
	if err != nil {
