...
//}
//
////// TestCreatePool is to test CStorPoolInstance creation.
////func TestCreatePool(t *testing.T) {
////	testPoolResource := map[string]struct {
////		expectedError error
////		test          *cstor.CStorPoolInstance
////	}{
////		"img1PoolResource": {
////			expectedError: nil,
////			test: &cstor.CStorPoolInstance{
...
////					UID: types.UID("abc"),
////				},
////				Spec: cstor.CStorPoolInstanceSpec{
////					PoolSpec: cstor.CStorPoolInstanceAttr{
...
////}
////
////// TestImportPool is to test CStorPoolInstance import.
...
////}
//
//// TestDeletePool is to test CStorPoolInstance delete.
...
////		expectedCapacity *cstor.CStorPoolInstanceCapacity
////	}{
////		"#1 OnlinePoolStatus": {
////			poolName: "cstor-530c9c4f-e0df-11e8-94a8-42010a80013b",
////			expectedCapacity: &cstor.CStorPoolInstanceCapacity{
////				GetQuantityFromString("9.94G"),
////				GetQuantityFromString("9.94G"),
////				GetQuantityFromString("202k"),
////			},
////		},
////	}
////	for name, test := range testPoolResource {
...
////}
//
////func GetQuantityFromString(q string)resource.Quantity  {
////	rq,err:=resource.ParseQuantity(q)
////	if err!=nil{
////		klog.Errorf("failed to parse qunatity :%s",err.Error())
////	}
////	return rq
////}
