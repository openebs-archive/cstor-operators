	...
	testPoolResource := map[string]struct {
		...
		"Valid-vol1Resource": {
			...
			test: &cstor.CStorVolumeReplica{
				...
				Spec: cstor.CStorVolumeReplicaSpec{
...
func TestVolumeStatus(t *testing.T) {
	testPoolResource := map[string]struct {
		...
		expectedStatus cstor.CStorVolumeReplicaPhase
	}{
...
func TestVolumeCapacity(t *testing.T) {
	testVolumeResource := map[string]struct {
		...
		expectedCapacity *cstor.CStorVolumeCapacityAttr
	}{
		"#1 VolumeCapacity": {
