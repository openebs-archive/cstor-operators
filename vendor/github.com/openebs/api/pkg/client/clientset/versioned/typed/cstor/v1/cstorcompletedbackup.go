...
type CStorCompletedBackupInterface interface {
	Create(*v1.CStorCompletedBackup) (*v1.CStorCompletedBackup, error)
	Update(*v1.CStorCompletedBackup) (*v1.CStorCompletedBackup, error)
	Delete(name string, options *metav1.DeleteOptions) error
	DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error
	Get(name string, options metav1.GetOptions) (*v1.CStorCompletedBackup, error)
	List(opts metav1.ListOptions) (*v1.CStorCompletedBackupList, error)
	Watch(opts metav1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.CStorCompletedBackup, err error)
...
func (c *cStorCompletedBackups) Get(name string, options metav1.GetOptions) (result *v1.CStorCompletedBackup, err error) {
...
func (c *cStorCompletedBackups) List(opts metav1.ListOptions) (result *v1.CStorCompletedBackupList, err error) {
...
func (c *cStorCompletedBackups) Watch(opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cStorCompletedBackups) Create(cStorCompletedBackup *v1.CStorCompletedBackup) (result *v1.CStorCompletedBackup, err error) {
	result = &v1.CStorCompletedBackup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cstorcompletedbackups").
...
func (c *cStorCompletedBackups) Update(cStorCompletedBackup *v1.CStorCompletedBackup) (result *v1.CStorCompletedBackup, err error) {
	result = &v1.CStorCompletedBackup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cstorcompletedbackups").
...
func (c *cStorCompletedBackups) Delete(name string, options *metav1.DeleteOptions) error {
...
func (c *cStorCompletedBackups) DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *cStorCompletedBackups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.CStorCompletedBackup, err error) {
	result = &v1.CStorCompletedBackup{}
