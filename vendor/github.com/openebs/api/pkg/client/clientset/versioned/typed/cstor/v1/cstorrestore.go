...
type CStorRestoreInterface interface {
	Create(*v1.CStorRestore) (*v1.CStorRestore, error)
	Update(*v1.CStorRestore) (*v1.CStorRestore, error)
	Delete(name string, options *metav1.DeleteOptions) error
	DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error
	Get(name string, options metav1.GetOptions) (*v1.CStorRestore, error)
	List(opts metav1.ListOptions) (*v1.CStorRestoreList, error)
	Watch(opts metav1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.CStorRestore, err error)
...
func (c *cStorRestores) Get(name string, options metav1.GetOptions) (result *v1.CStorRestore, err error) {
...
func (c *cStorRestores) List(opts metav1.ListOptions) (result *v1.CStorRestoreList, err error) {
...
func (c *cStorRestores) Watch(opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cStorRestores) Create(cStorRestore *v1.CStorRestore) (result *v1.CStorRestore, err error) {
	result = &v1.CStorRestore{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cstorrestores").
...
func (c *cStorRestores) Update(cStorRestore *v1.CStorRestore) (result *v1.CStorRestore, err error) {
	result = &v1.CStorRestore{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cstorrestores").
...
func (c *cStorRestores) Delete(name string, options *metav1.DeleteOptions) error {
...
func (c *cStorRestores) DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *cStorRestores) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.CStorRestore, err error) {
	result = &v1.CStorRestore{}
