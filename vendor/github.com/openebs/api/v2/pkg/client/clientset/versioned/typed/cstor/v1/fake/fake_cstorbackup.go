...
func (c *FakeCStorBackups) Get(name string, options v1.GetOptions) (result *cstorv1.CStorBackup, err error) {
	obj, err := c.Fake.
...
func (c *FakeCStorBackups) List(opts v1.ListOptions) (result *cstorv1.CStorBackupList, err error) {
	obj, err := c.Fake.
...
func (c *FakeCStorBackups) Create(cStorBackup *cstorv1.CStorBackup) (result *cstorv1.CStorBackup, err error) {
	obj, err := c.Fake.
...
func (c *FakeCStorBackups) Update(cStorBackup *cstorv1.CStorBackup) (result *cstorv1.CStorBackup, err error) {
	obj, err := c.Fake.
...
func (c *FakeCStorBackups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *cstorv1.CStorBackup, err error) {
	obj, err := c.Fake.
