...
func (c *cStorBackups) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.CStorBackup, err error) {
...
func (c *cStorBackups) List(ctx context.Context, opts metav1.ListOptions) (result *v1.CStorBackupList, err error) {
...
func (c *cStorBackups) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cStorBackups) Create(ctx context.Context, cStorBackup *v1.CStorBackup, opts metav1.CreateOptions) (result *v1.CStorBackup, err error) {
	result = &v1.CStorBackup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cstorbackups").
...
func (c *cStorBackups) Update(ctx context.Context, cStorBackup *v1.CStorBackup, opts metav1.UpdateOptions) (result *v1.CStorBackup, err error) {
	result = &v1.CStorBackup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cstorbackups").
...
func (c *cStorBackups) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *cStorBackups) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *cStorBackups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.CStorBackup, err error) {
	result = &v1.CStorBackup{}
