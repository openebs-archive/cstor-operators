...
func (c *cStorVolumeReplicas) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.CStorVolumeReplica, err error) {
...
func (c *cStorVolumeReplicas) List(ctx context.Context, opts metav1.ListOptions) (result *v1.CStorVolumeReplicaList, err error) {
...
func (c *cStorVolumeReplicas) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cStorVolumeReplicas) Create(ctx context.Context, cStorVolumeReplica *v1.CStorVolumeReplica, opts metav1.CreateOptions) (result *v1.CStorVolumeReplica, err error) {
	result = &v1.CStorVolumeReplica{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cstorvolumereplicas").
...
func (c *cStorVolumeReplicas) Update(ctx context.Context, cStorVolumeReplica *v1.CStorVolumeReplica, opts metav1.UpdateOptions) (result *v1.CStorVolumeReplica, err error) {
	result = &v1.CStorVolumeReplica{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cstorvolumereplicas").
...
func (c *cStorVolumeReplicas) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *cStorVolumeReplicas) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *cStorVolumeReplicas) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.CStorVolumeReplica, err error) {
	result = &v1.CStorVolumeReplica{}
