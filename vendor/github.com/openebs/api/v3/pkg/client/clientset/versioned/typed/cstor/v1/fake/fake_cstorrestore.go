...
var cstorrestoresResource = schema.GroupVersionResource{Group: "cstor.openebs.io", Version: "v1", Resource: "cstorrestores"}
...
func (c *FakeCStorRestores) Get(ctx context.Context, name string, options v1.GetOptions) (result *cstorv1.CStorRestore, err error) {
	...
	return obj.(*cstorv1.CStorRestore), err
}
...
func (c *FakeCStorRestores) List(ctx context.Context, opts v1.ListOptions) (result *cstorv1.CStorRestoreList, err error) {
	...
	list := &cstorv1.CStorRestoreList{ListMeta: obj.(*cstorv1.CStorRestoreList).ListMeta}
	for _, item := range obj.(*cstorv1.CStorRestoreList).Items {
