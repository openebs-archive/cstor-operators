...
var cstorrestoresResource = schema.GroupVersionResource{Group: "openebs.io", Version: "v1alpha1", Resource: "cstorrestores"}

var cstorrestoresKind = schema.GroupVersionKind{Group: "openebs.io", Version: "v1alpha1", Kind: "CStorRestore"}
...
func (c *FakeCStorRestores) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CStorRestore, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(cstorrestoresResource, c.ns, name), &v1alpha1.CStorRestore{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.CStorRestore), err
}
...
func (c *FakeCStorRestores) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CStorRestoreList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(cstorrestoresResource, cstorrestoresKind, c.ns, opts), &v1alpha1.CStorRestoreList{})
	...
	list := &v1alpha1.CStorRestoreList{ListMeta: obj.(*v1alpha1.CStorRestoreList).ListMeta}
	for _, item := range obj.(*v1alpha1.CStorRestoreList).Items {
...
func (c *FakeCStorRestores) Create(ctx context.Context, cStorRestore *v1alpha1.CStorRestore, opts v1.CreateOptions) (result *v1alpha1.CStorRestore, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(cstorrestoresResource, c.ns, cStorRestore), &v1alpha1.CStorRestore{})
...
func (c *FakeCStorRestores) Update(ctx context.Context, cStorRestore *v1alpha1.CStorRestore, opts v1.UpdateOptions) (result *v1alpha1.CStorRestore, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(cstorrestoresResource, c.ns, cStorRestore), &v1alpha1.CStorRestore{})
...
func (c *FakeCStorRestores) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(cstorrestoresResource, c.ns, name), &v1alpha1.CStorRestore{})
...
func (c *FakeCStorRestores) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha1.CStorRestoreList{})
	return err
}
...
func (c *FakeCStorRestores) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CStorRestore, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(cstorrestoresResource, c.ns, name, pt, data, subresources...), &v1alpha1.CStorRestore{})
