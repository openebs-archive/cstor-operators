...
func (c *migrationTasks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MigrationTask, err error) {
...
func (c *migrationTasks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MigrationTaskList, err error) {
...
func (c *migrationTasks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *migrationTasks) Create(ctx context.Context, migrationTask *v1alpha1.MigrationTask, opts v1.CreateOptions) (result *v1alpha1.MigrationTask, err error) {
	result = &v1alpha1.MigrationTask{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("migrationtasks").
...
func (c *migrationTasks) Update(ctx context.Context, migrationTask *v1alpha1.MigrationTask, opts v1.UpdateOptions) (result *v1alpha1.MigrationTask, err error) {
	result = &v1alpha1.MigrationTask{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("migrationtasks").
...
func (c *migrationTasks) UpdateStatus(ctx context.Context, migrationTask *v1alpha1.MigrationTask, opts v1.UpdateOptions) (result *v1alpha1.MigrationTask, err error) {
	result = &v1alpha1.MigrationTask{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("migrationtasks").
...
func (c *migrationTasks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *migrationTasks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *migrationTasks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MigrationTask, err error) {
	result = &v1alpha1.MigrationTask{}
