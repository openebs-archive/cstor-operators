...
func (c *upgradeTasks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.UpgradeTask, err error) {
...
func (c *upgradeTasks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.UpgradeTaskList, err error) {
...
func (c *upgradeTasks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *upgradeTasks) Create(ctx context.Context, upgradeTask *v1alpha1.UpgradeTask, opts v1.CreateOptions) (result *v1alpha1.UpgradeTask, err error) {
	result = &v1alpha1.UpgradeTask{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("upgradetasks").
...
func (c *upgradeTasks) Update(ctx context.Context, upgradeTask *v1alpha1.UpgradeTask, opts v1.UpdateOptions) (result *v1alpha1.UpgradeTask, err error) {
	result = &v1alpha1.UpgradeTask{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("upgradetasks").
...
func (c *upgradeTasks) UpdateStatus(ctx context.Context, upgradeTask *v1alpha1.UpgradeTask, opts v1.UpdateOptions) (result *v1alpha1.UpgradeTask, err error) {
	result = &v1alpha1.UpgradeTask{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("upgradetasks").
...
func (c *upgradeTasks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *upgradeTasks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *upgradeTasks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.UpgradeTask, err error) {
	result = &v1alpha1.UpgradeTask{}
