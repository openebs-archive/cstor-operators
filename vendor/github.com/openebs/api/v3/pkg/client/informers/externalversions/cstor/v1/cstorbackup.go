	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.CstorV1().CStorBackups(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CstorV1().CStorBackups(namespace).Watch(context.TODO(), options)
			},
		},
		&cstorv1.CStorBackup{},
		resyncPeriod,
...
func (f *cStorBackupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cstorv1.CStorBackup{}, f.defaultInformer)
}

func (f *cStorBackupInformer) Lister() v1.CStorBackupLister {
	return v1.NewCStorBackupLister(f.Informer().GetIndexer())
}
