...
type CStorCompletedBackupInformer interface {
	...
	Lister() v1.CStorCompletedBackupLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.CstorV1().CStorCompletedBackups(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CstorV1().CStorCompletedBackups(namespace).Watch(context.TODO(), options)
			},
		},
		&cstorv1.CStorCompletedBackup{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *cStorCompletedBackupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cstorv1.CStorCompletedBackup{}, f.defaultInformer)
}

func (f *cStorCompletedBackupInformer) Lister() v1.CStorCompletedBackupLister {
	return v1.NewCStorCompletedBackupLister(f.Informer().GetIndexer())
}
