	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.CstorV1().CStorPoolInstances(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CstorV1().CStorPoolInstances(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *cStorPoolInstanceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cstorv1.CStorPoolInstance{}, f.defaultInformer)
}
